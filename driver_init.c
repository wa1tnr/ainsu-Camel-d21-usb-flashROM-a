...
/* imported code segment follows. */

/* task: compare the two _init() routines to see where if in any place
         they overlap, are redundant, name the same resource, &c.  DONE.
*/
